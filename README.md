...
* **Data Augmentation:** `Albumentations` 
  * Included spatial augmentations (ElasticTransform, GridDistortion, ShiftScaleRotate) and pixel-level adjustments (RandomBrightnessContrast) to enforce strict generalization.
...
* Developed as part of an ongoing initiative to build robust, fault-tolerant computer vision pipelines for deep learning research.
